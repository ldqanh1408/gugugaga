...
// Future mail routes
router.post("/:userId/future-mails", auth.authToken, userController.addFutureMail);
router.get("/:userId/future-mails", auth.authToken, userController.getFutureMails);
router.patch("/:userId/future-mails/:mailId", auth.authToken, userController.updateFutureMail);
