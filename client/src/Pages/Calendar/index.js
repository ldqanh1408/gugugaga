    ...
    <div className="container parent">
      <Row className="justify-content-between gap-3">
        ...
        <Col md={5} className="custom-right">
          ...
          {notifications.length === 0 && selectedDate ? (
              ...
              <Card key={item._id} className="mb-3 custom-card">
                <Card.Body className="custom-card-content">
                  <div className="card-header">
                    <span className="time-text">{formatTimeFromCreatedAt(item.createdAt)}</span>
                  </div>

                  <div className="card-body">
                    <span className="date-text">{formatDateLocal(item.createdAt)}</span>
